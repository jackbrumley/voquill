...
- **Multiple prompts & style presets** — Create, name, select, and delete post-processing presets (includes built-in presets for grammar cleanup, concise notes, and email polish). Switch between them in settings.
